/// A utility class for defining common width values in logical pixels.
///
/// The `Width` class provides a set of predefined constants representing
/// commonly used width values. These constants help maintain consistency
/// and readability in your UI layouts.
///
/// ### Example Usage
/// ```dart
/// Container(
///   width: Width.w16, // Set the width to 16 logical pixels
///   height: Width.w10, // Set the height to 40 logical pixels
///   color: Colors.blue,
/// );
/// ```
///
