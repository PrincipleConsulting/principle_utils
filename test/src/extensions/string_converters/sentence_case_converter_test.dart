...
import 'package:principle_utils/src/extensions/string_converters/sentence_case_converter.dart';
...
void main() {
  group('SentenceCaseConverter', () {
    ...
    test('Multiple words returns sentence case', () {
      ...
      expect(converter.convert('hELLO WoRLD'), equals('Hello world'));
      expect(
          converter.convert('hello   world  test'), equals('Hello world test'));
    });
  });
}
