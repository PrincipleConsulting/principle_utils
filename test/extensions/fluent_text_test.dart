...
void main() {
  group('FluentTextExtension', () {
    ...
    test('textFeatures sets fontFeatures correctly', () {
      const TextStyle style = TextStyle();
      final List<FontFeature> features = <FontFeature>[const FontFeature.tabularFigures()];
    ...
    test('leadingDistribution sets leading distribution correctly', () {
      const TextStyle style = TextStyle();
      final TextStyle newStyle = style.textLeadingDist(TextLeadingDistribution.even);
      expect(newStyle.leadingDistribution, equals(TextLeadingDistribution.even));
    });
    ...
    test('fontVariations sets fontVariations correctly', () {
      const TextStyle style = TextStyle();
      final List<FontVariation> variations = <FontVariation>[const FontVariation('wght', 400)];
    ...
    test('decorationStyle sets decoration style correctly', () {
      const TextStyle style = TextStyle();
      final TextStyle newStyle = style.textDecorationStyle(TextDecorationStyle.wavy);
    ...
    test('chain multiple fluent extensions', () {
      ...
      final TextStyle newStyle =
          style.bold.italic.size(20).textColor(Colors.blue).underline.letterSpace(1.0).wordSpace(2.0).textHeight(1.5).textFontFamily('Roboto');
