...
void main() {
  group('responsive extension', () {
    testWidgets('returns default value when width is less than 640', (WidgetTester tester) async {
    ...
    testWidgets('returns sm value when width is between 640 and 768', (WidgetTester tester) async {
      final double dpi = tester.view.devicePixelRatio;
    ...
    testWidgets('returns md value when width is between 768 and 1024', (WidgetTester tester) async {
      final double dpi = tester.view.devicePixelRatio;
    ...
    testWidgets('returns lg value when width is between 1024 and 1280', (WidgetTester tester) async {
      final double dpi = tester.view.devicePixelRatio;
    ...
    testWidgets('returns xl value when width is greater than or equal to 1280', (WidgetTester tester) async {
      final double dpi = tester.view.devicePixelRatio;
    ...
    testWidgets('falls back correctly when some parameters are null (for xl branch)', (WidgetTester tester) async {
    ...
    testWidgets('falls back correctly for lg branch when width is between 1024 and 1280', (WidgetTester tester) async {
    ...
    testWidgets('falls back correctly for md branch when width is between 768 and 1024', (WidgetTester tester) async {
